...
# and vim
# this works for ipython; for ptipython, see setting in ~/.config/ptipython/config.py
c.TerminalInteractiveShell.shortcuts = [
    {
        'command': 'IPython:auto_suggest.accept',  # Command to trigger completion
        'match_keys': ['c-o'],                    # Shortcut (Ctrl+O)
        'match_filter': 'vi_insert_mode',         # Adjust context as needed
    }
]
